...
function handleResponse() {
	...
	if(httpRequest.readyState == 4) {
		if(httpRequest.status ==200) {
			...
			//console.log(response+"Response Hellpppp")
...
<input type ="submit" name = "covax" id = "cova" value = "Covaxin" onclick = "getCovaxin()" class = "c1"><div id = "vaccineresult"></div>
	<div>
	<div class = "details" align = "center"><h4 style="background-color: white;"> The User survey details are below:</h4></div>
	<table border = "2px" id = "tab" class = "tab1" align = "center" style="background-color: #ffc3a0;">
		<tr>
			<th>Name</th>
			<th>Gender</th>
			<th>Age</th>
